...
// The Wall2 class represents one of the walls in the game
public class Wall2 extends Walls {

    private List<Item> items = new ArrayList<Item>();
    private String name = "Wall 2";
    ...
    public Wall2(boolean isFirstTime) {
        isInteractable = true;
        isCollectable = false;
        isCombinable = false;
    ...
    public JSONObject toJson() {
        ...
        json.put("name", name);
        json.put("isFirstTimeWall2", isFirstTime);
        return json;
    }
